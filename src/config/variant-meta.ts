...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  ...
  energy: {
    title: "Grid's Eye View - US Energy Infrastructure Intelligence",
    description: 'US energy infrastructure on one map — power plants, transmission lines, and oil & gas pipelines, with live EIA electricity, natural gas, and grid-demand data.',
    socialDescription: 'Every US power plant, transmission line, and oil & gas pipeline on one map, with live EIA electricity price, natural gas, and grid-demand data. Built for energy professionals.',
    ...
    categories: ['news', 'business'],
    features: [
      'Global power plant mapping',
      'US transmission line tracking',
      'Oil & gas pipeline & field mapping',
      'Live grid demand & generation (EIA)',
      'US retail electricity prices (EIA)',
      'Henry Hub natural gas prices (EIA)',
      'EIA Today in Energy feed',
      'Utility Dive & OilPrice news feeds',
      'Weather & natural disaster overlays',
      'Per-country electricity generation mix',
    ],
  },
  commodity: {
